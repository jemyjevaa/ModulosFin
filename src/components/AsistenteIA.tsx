  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button className="px-6 py-2.5 bg-navy text-white text-[13px] font-bold rounded-lg hover:bg-navy-mid transition-all shadow-lg shadow-navy/20 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden min-h-[400px]">
            ...
            <div className="p-6 space-y-4">
              {predictions.map((p, i) => (
                ...
                >
                  <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center text-navy shadow-sm group-hover:scale-110 transition-transform">
                  ...
                  <div className="text-right flex items-center gap-6">
                    ...
                    <button className="px-4 py-2 bg-navy text-white text-[11px] font-bold uppercase tracking-widest rounded-lg hover:bg-navy-mid transition-all shadow-sm">
                      Aceptar Sugerencia
                    </button>
          ...
          <div className="bg-navy rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl shadow-navy/20">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <div className="p-5 bg-navy-mid/50 border border-white/10 rounded-2xl flex items-start gap-4">
                <div className="w-8 h-8 bg-teal-mid rounded-lg flex items-center justify-center shadow-lg pt-0.5">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-br from-amber to-amber-mid rounded-2xl p-6 text-navy shadow-xl shadow-amber/20">
             ...
             <button className="w-full py-2.5 bg-navy text-white rounded-lg text-xs font-black uppercase tracking-widest hover:scale-[1.02] transition-transform shadow-lg">Asignar Ahora →</button>
          </div>
        </div>
      </div>
    </div>
